package com.material.collections.adapter;
...
import com.material.collections.model.Message;

import java.util.ArrayList;
import java.util.List;

public class AdapterChatFacebook extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterChatFacebook(Context context) {
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == CHAT_ME) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chat_facebook_me, parent, false);
            vh = new ItemViewHolder(v);
        } else {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chat_facebook_you, parent, false);
            vh = new ItemViewHolder(v);
        }
        return vh;
    }
