...
public class SharedPref {
    ...
    private static final int MAX_CLICK_OFFER = BuildConfig.DEBUG ? Integer.MAX_VALUE : 8;
    private static final int MAX_CLICK_INTERS = BuildConfig.DEBUG ? Integer.MAX_VALUE : 8;
