...
public class ListNewsLight extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("News Light");
    ...
    private void initComponent() {
        ...
        mAdapter = new AdapterListNews(this, items, R.layout.item_news_light);
