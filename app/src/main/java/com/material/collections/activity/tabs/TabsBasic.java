package com.material.collections.activity.tabs;
...
public class TabsBasic extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(PlaceholderFragment.newInstance(1), "ITEM ONE");
        adapter.addFragment(PlaceholderFragment.newInstance(2), "ITEM TWO");
        adapter.addFragment(PlaceholderFragment.newInstance(3), "ITEM THREE");
